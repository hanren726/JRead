...
public class ScreenSizeUtil {
	...
	public static ScreenSize getScreenSize(){
		WindowManager w = (WindowManager) JApplication.getAppContext().getSystemService(Context.WINDOW_SERVICE);
		...
		DisplayMetrics dm = JApplication.getAppContext().getResources().getDisplayMetrics();
    ...
    public static int getStatusBarHeight() {
        Resources resources = JApplication.getAppContext().getResources();
        int result = 0;
    ...
    public static int getNavBarHeight() {
        Context context = JApplication.getAppContext();
    ...
    public static boolean hasPermanentMenuKey() {
        boolean hasMenuKey;
        ViewConfiguration vc = ViewConfiguration.get(JApplication.getAppContext());
